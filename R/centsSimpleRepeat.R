...
centSR <- read_delim('../data/CENH3/Summary.repetitive.bed.list',delim = '\t',
                     col_names = F)
ggplot(centSR,aes(x = X1,y=X3,fill=X2)) + 
  ...
  labs(x = 'Chromosome',y = 'Frequency',
       fill = 'The top 10 repeats')
ggsave('../figure/figure1/cent.SR.barplot.pdf',width = 6.3,height = 3.6)
